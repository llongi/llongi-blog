...
programming in Python and especially C, I truly, deeply love C as a language, and find its no-nonsense approach, where control truly lies with the
programmer, very refreshing. I kinda dislike the object-oriented hype, while I find OO and its paradigms often useful, I don't consider them a
solution to all possible problems, and don't try to fit everything into classes and patterns just because. As for all problems in life, careful
analysis and thinking things through will get you the answer, not the thoughtless application of pre-confectioned solutions.
<br />
I find that C heavily stimulates this approach, mostly by there being very little pre-confectioned available for thoughtless, random use.
...
the Belgariad / Mallorean, A Song of Ice and Fire, The Mistborn. I also enjoy the cinematic versions of those novels, like the Game of Thrones
series, and generally good sci-fi (StarGate, Star Trek, Star Wars, Andromeda) and good crime/mystery (The Mentalist, Castle, Criminal Minds, CSI) series.
Of course, good comedy, anime and cartoons round up the offering: Family Guy, American Dad, Futurama, The Big Bang Theory and How I Met Your Mother
...
wine from time to time completes the setting. In the end I could probably do with a little more physical exercise.
	</div>
</div>
